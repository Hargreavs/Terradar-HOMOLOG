  ...
  return (
    ...
    >
      ...
      >
        ...
        {(() => {
          const a = ((sweepAngle + 40) * Math.PI) / 180
          return (
            <line
              x1={CX}
              y1={CY}
              x2={CX + 370 * Math.cos(a)}
              y2={CY + 370 * Math.sin(a)}
              stroke={COLORS.ambar}
              strokeOpacity={0.35}
              strokeWidth={0.8}
            />
        ...
        {Array.from({ length: 72 }, (_, i) => {
          ...
          return (
            <line
              ...
              y2={CY + 370 * Math.sin(a)}
              stroke={COLORS.ambar}
              strokeOpacity={major ? 0.15 : minor ? 0.08 : 0.04}
        ...
        {(
          ...
          return (
            <text
              key={l}
              x={CX + 385 * Math.cos(rad)}
              y={CY + 385 * Math.sin(rad) + 3}
              fill={COLORS.ambar}
              fillOpacity={0.1}
              fontSize={8}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div
            style={{
              ...
              boxShadow: `0 0 8px ${COLORS.ambar}`,
            }}
          />
          <span
            style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 5, alignItems: 'center' }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    height: 7,
                    borderRadius: 2,
                    background: lit ? m.color : COLORS.border,
            ...
            >
              {
                MINERALS.filter((m) => {
                  const a = angleBetween(CX, CY, CX + m.x, CY + m.y)
                  return Math.abs(angleDiff(sweepAngle, a)) < 50
                }).length
              }
            </span>
          </div>
