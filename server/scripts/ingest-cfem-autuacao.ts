...
import { criarStreamLimpezaAspas, parseDecimalBR, upsertBatch } from './lib/csv-utils'
...
;(async () => {
  ...
  console.log(
    `\nOK Autuação: ${total} processadas, ${inseridos} enviadas em batch, ${pulados} puladas, ${erros} erros em ${tempoSeg}s`,
  )
